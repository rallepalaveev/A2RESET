A2COLDRESET is a project for a controller card for Apple 2 computers, which has an external button, which, when pressed, performs cold restart of the computer, similar to what the open-apple reset does on the Apple 2e.
...
4. The program self-moves to $0300 and exctes from there, in the meantime zeroing most of $0300-#03FF, including $03F3 anf $03F4.
